...
export const FILTERED_SERVER_MAP_DATA = `${LOCAL_API_PATH}/servermap/filterServerMap`;
...
export const TRANSACTION_TRACE_SERVER_MAP_LINK = `${LOCAL_API_PATH}/transaction/traceServerMap/link`;
export const TRANSACTION_TRACE_CALL_TREE = `${LOCAL_API_PATH}/transaction/traceCallTree`;
// export const = '/transaction/transactionTimelineInfo';
// export const = '/sqlBind';
// export const = '/jsonBind';
export const SCATTER_DATA = `${LOCAL_API_PATH}/getScatterData`;
export const HEATMAP_APP_DATA = `${LOCAL_API_PATH}/heatmap/applicationData`;
...
export const TRACE_VIEWER_DATA = `${LOCAL_API_PATH}/transaction/traceViewerData`;
export const TRACE_VIEWER_DATA_LINK = `${LOCAL_API_PATH}/transaction/traceViewerData/link`;
...
export const AGENT_OVERVIEW = `${LOCAL_API_PATH}/agents/overview`;
export const AGENT_LIST = `${LOCAL_API_PATH}/agents`;
